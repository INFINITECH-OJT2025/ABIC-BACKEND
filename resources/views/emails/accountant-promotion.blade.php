...
<head>
    ...
    <title>Accountant Promotion Notification</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 class="title">Accountant Role Promotion</h1>
        </div>

        <p>Hello <strong>{{ $userName }}</strong>,</p>

        <p>We are pleased to inform you that you have been promoted to the role of <strong>Accountant</strong> in {{ $appName }}.</p>

        <div class="highlight">
            <strong>What this means for you:</strong><br>
            You now have accountant access to the system. You can log in with your existing credentials and access accountant features and permissions.
        </div>

        <p style="text-align: center;">
            <a href="{{ $loginUrl }}" class="login-button">
                Log in to Your Accountant Account
            </a>
        </p>
