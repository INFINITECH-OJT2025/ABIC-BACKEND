...
{
    /**
     * Backfill owner_ledger_entries from existing transactions.
     * Run after create_owner_ledger_entries_table.
     */
    public function up(): void
    {
        ...
        foreach ($transactions as $t) {
            ...
            // From owner: CREDIT (Main: decrease, Client: increase)
            ...
            // To owner: DEBIT (Main: increase, Client: decrease)
    ...
    /**
     * Reverse - cannot undo backfill safely.
     */
